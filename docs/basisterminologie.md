...
Een externe identificatie beschrijft gegevens waarmee een partij in een extern (dus buiten het domein van klantinteracties) register uniek geïdentificeerd kan worden. Voor Nederlandse partijen zullen dit met name Burgerservicenummers, KVK- en RSIN-nummers zijn die hun bron hebben in de Basisregistratie personen en het Handelsregister, maar externe identificatie biedt expliciet ook de mogelijkheid om andere binnen- of buitenlandse identificatienummers te registreren.
