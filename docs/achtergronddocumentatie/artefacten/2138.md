...
Aangenomen wordt dat er software gebruikt wordt om het ontvange post in te scannen en te digitaliseren.
...
- Er wordt mogelijk een een `interneTaak` vastgelegd volgens functie [F2120 - Registreer interne taak](./2120) als het App-verkeer daartoe aanleiding gaf. 
