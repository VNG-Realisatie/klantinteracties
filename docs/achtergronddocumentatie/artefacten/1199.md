...
- Vanuit een mailservice wordt eerst een `informatieobject` aangemaakt waarin de email wordt vastgelegd. Zie de documentatie over de [Standaarden voor zaakgericht werken](https://vng-realisatie.github.io/gemma-zaken/) werken voor het aanmaken van een informatieobject.
