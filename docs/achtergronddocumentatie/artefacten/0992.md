...
_Let op: een besluit naar aanleiding van openstaand [vraagstuk 6898](docs/achtergronddocumentatie/artefacten/6898.md) over in welke gevallen, en met welke doelen we een klantcontact registreren heeft mogelijk invloed op de gegevens die bij deze casus worden geregistreerd._
