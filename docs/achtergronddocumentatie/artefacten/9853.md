...
- Er wordt een `informatieobject` aangemaakt waarin de afslag van het App-gesprek wordt vastgelegd. Zie de documentatie over de [Standaarden voor zaakgericht werken](https://vng-realisatie.github.io/gemma-zaken/) voor het aanmaken van een informatieobject.
