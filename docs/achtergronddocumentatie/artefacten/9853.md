...
- Er wordt een `informatieobject` aangemaakt waarin de inhoud van het App-gesprek wordt vastgelegd. Zie de documentatie over de [Standaarden voor zaakgericht werken](https://vng-realisatie.github.io/gemma-zaken/) voor het aanmaken van een informatieobject.
...
| - `inhoud` | | Indien gewenst kan in de inhoud de tekst van het app-gesprek worden opgenomen, maar deze inhoud ligt ook vast in het aangemaakte informatieobject.  | 
